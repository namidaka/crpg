...
[Migration("20231016114551_AddMapConfiguration")]
partial class AddMapConfiguration
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "game_mode", new[] { "crpg_battle", "crpg_conquest", "crpgdtv", "crpg_duel", "crpg_siege", "crpg_team_deathmatch" });
        ...
        modelBuilder.Entity("Crpg.Domain.Entities.GameServers.GameServerConfig", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("integer")
                ...
                b.Property<bool?>("AllowPollsToChangeMaps")
                    .HasColumnType("boolean")
                    .HasColumnName("allow_polls_to_change_maps");

                b.Property<bool?>("AllowPollsToKickPlayers")
                    .HasColumnType("boolean")
                    .HasColumnName("allow_polls_to_kick_players");

                b.Property<int?>("AutoTeamBalanceThreshold")
                    .HasColumnType("integer")
                    .HasColumnName("auto_team_balance_threshold");

                b.Property<DateTime>("CreatedAt")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("created_at");

                b.Property<bool?>("Crpg_apply_harmony_patches")
                    .HasColumnType("boolean")
                    .HasColumnName("crpg_apply_harmony_patches");

                b.Property<float?>("Crpg_experience_multiplier")
                    .HasColumnType("real")
                    .HasColumnName("crpg_experience_multiplier");

                b.Property<TimeSpan?>("Crpg_happy_hours")
                    .HasColumnType("interval")
                    .HasColumnName("crpg_happy_hours");

                b.Property<int?>("Crpg_reward_tick")
                    .HasColumnType("integer")
                    .HasColumnName("crpg_reward_tick");

                b.Property<bool?>("Crpg_team_balance_once")
                    .HasColumnType("boolean")
                    .HasColumnName("crpg_team_balance_once");

                b.Property<float?>("Crpg_team_balancer_clan_group_size_penalty")
                    .HasColumnType("real")
                    .HasColumnName("crpg_team_balancer_clan_group_size_penalty");

                b.Property<Culture>("CultureTeam1")
                    .HasColumnType("culture")
                    .HasColumnName("culture_team1");

                b.Property<Culture>("CultureTeam2")
                    .HasColumnType("culture")
                    .HasColumnName("culture_team2");

                b.Property<bool?>("DisableCultureVoting")
                    .HasColumnType("boolean")
                    .HasColumnName("disable_culture_voting");

                b.Property<bool?>("Enable_automated_battle_switching")
                    .HasColumnType("boolean")
                    .HasColumnName("enable_automated_battle_switching");

                b.Property<bool?>("End_game_after_mission_is_over")
                    .HasColumnType("boolean")
                    .HasColumnName("end_game_after_mission_is_over");

                b.Property<int?>("FriendlyFireDamageMeleeFriendPercent")
                    .HasColumnType("integer")
                    .HasColumnName("friendly_fire_damage_melee_friend_percent");

                b.Property<int?>("FriendlyFireDamageMeleeSelfPercent")
                    .HasColumnType("integer")
                    .HasColumnName("friendly_fire_damage_melee_self_percent");

                b.Property<int?>("FriendlyFireDamageRangedFriendPercent")
                    .HasColumnType("integer")
                    .HasColumnName("friendly_fire_damage_ranged_friend_percent");

                b.Property<int?>("FriendlyFireDamageRangedSelfPercent")
                    .HasColumnType("integer")
                    .HasColumnName("friendly_fire_damage_ranged_self_percent");
                ...
                b.Property<string>("GamePassword")
                    .HasColumnType("text")
                    .HasColumnName("game_password");

                b.Property<int?>("MapTimeLimit")
                    .HasColumnType("integer")
                    .HasColumnName("map_time_limit");

                b.Property<int>("MaxNumberOfPlayers")
                    .HasColumnType("integer")
                    .HasColumnName("max_number_of_players");

                b.Property<int?>("MinNumberOfPlayersForMatchStart")
                    .HasColumnType("integer")
                    .HasColumnName("min_number_of_players_for_match_start");

                b.Property<int?>("MinScoreToWinDuel")
                    .HasColumnType("integer")
                    .HasColumnName("min_score_to_win_duel");

                b.Property<int>("NumberOfBotsTeam1")
                    .HasColumnType("integer")
                    .HasColumnName("number_of_bots_team1");

                b.Property<int>("NumberOfBotsTeam2")
                    .HasColumnType("integer")
                    .HasColumnName("number_of_bots_team2");

                b.Property<Region>("Region")
                    .HasColumnType("region")
                    .HasColumnName("region");

                b.Property<int?>("RespawnPeriodTeam1")
                    .HasColumnType("integer")
                    .HasColumnName("respawn_period_team1");

                b.Property<int?>("RespawnPeriodTeam2")
                    .HasColumnType("integer")
                    .HasColumnName("respawn_period_team2");

                b.Property<int?>("RoundPreparationTimeLimit")
                    .HasColumnType("integer")
                    .HasColumnName("round_preparation_time_limit");

                b.Property<int?>("RoundTimeLimit")
                    .HasColumnType("integer")
                    .HasColumnName("round_time_limit");

                b.Property<int?>("RoundTotal")
                    .HasColumnType("integer")
                    .HasColumnName("round_total");

                b.Property<int>("ServerInstance")
                    .HasColumnType("integer")
                ...
                b.Property<bool?>("Set_automated_battle_count")
                    .HasColumnType("boolean")
                    .HasColumnName("set_automated_battle_count");

                b.Property<DateTime>("UpdatedAt")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("updated_at");

                b.Property<int?>("WarmupTimeLimit")
                    .HasColumnType("integer")
                    .HasColumnName("warmup_time_limit");
                ...
                b.HasKey("Id")
                    .HasName("pk_game_server_configs");

                b.ToTable("game_server_configs", (string)null);
            });

        modelBuilder.Entity("Crpg.Domain.Entities.GameServers.Map", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("integer")
                ...
                b.Property<int>("GameServerConfigId")
                    .HasColumnType("integer")
                    .HasColumnName("game_server_config_id");
                ...
                b.HasIndex("GameServerConfigId")
                    .HasDatabaseName("ix_maps_game_server_config_id");
        ...
        modelBuilder.Entity("Crpg.Domain.Entities.GameServers.Map", b =>
            {
                b.HasOne("Crpg.Domain.Entities.GameServers.GameServerConfig", "GameServerConfig")
                    .WithMany("Maps")
                    .HasForeignKey("GameServerConfigId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired()
                    .HasConstraintName("fk_maps_game_server_configs_game_server_config_id");

                b.Navigation("GameServerConfig");
            });
