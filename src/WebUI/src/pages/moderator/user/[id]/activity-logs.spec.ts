...
// const { mockedGetActivityLogs } = vi.hoisted(() => ({
//   mockedGetActivityLogs: vi.fn().mockResolvedValue({ logs: [], users: {} }),
// }));
// vi.mock('@/services/activity-logs-service', () => ({
//   getActivityLogs: mockedGetActivityLogs,
// }));
...
// it('basic', async () => {
//   mockedGetActivityLogs.mockResolvedValue(mockData);
//   const { wrapper } = await mountWithRouter(mountOptions, routes, route);

//   expect(wrapper).toBeDefined();
//   expect(mockedGetActivityLogs).toBeCalledWith({
...
//   expect(mockedGetActivityLogs).toHaveBeenNthCalledWith(2, {
//     from: new Date('2023-03-30T17:55:00.0000000Z'),
//     to: new Date(),
//     type: [],
...
//   expect(mockedGetActivityLogs).toHaveBeenNthCalledWith(3, {
//     from: new Date('2023-03-30T17:55:00.0000000Z'),
//     to: new Date(),
//     type: [],
//     userId: [CURRENT_USER_ID],
