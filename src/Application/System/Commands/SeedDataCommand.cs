    ...
    internal class Handler : IMediatorRequestHandler<SeedDataCommand>
    {
        ...
        private async Task AddDevelopmentData()
        {
            ...
            ActivityLog[] newActivityLogCharacterEarned =
            {
                ...
                new() { Type = ActivityLogType.CharacterEarned, User = orle, CreatedAt = DateTime.UtcNow.AddMinutes(-35), Metadata = { new("characterId", "6"), new("gameMode", "CRPGDTV"), new("experience", "32000"), new("gold", "-989") } },
